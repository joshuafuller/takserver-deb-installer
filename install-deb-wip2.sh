...
echo ""
sudo keytool -importkeystore -deststorepass atakatak -destkeystore /opt/tak/certs/files/takserver.jks -srckeystore ~/$HOSTNAME.p12 -srcstoretype PKCS12
sudo keytool -import -alias bundle -trustcacerts -file /etc/letsencrypt/live/$FQDN/fullchain.pem -keystore /opt/tak/certs/files/takserver.jks
